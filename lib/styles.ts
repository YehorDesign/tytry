...
export const CAPTION_STYLES: CaptionStyle[] = [
  ...
  },
  {
    ...
    positionY: 0.5,
    designWords: [
      { sizeMult: 2.2, font: "DynaPuff", weight: 400, rotate: -2, anim: "blur" },
      { sizeMult: 0.75, font: "DynaPuff", weight: 400, anim: "rise" },
      { sizeMult: 1.7, font: "DynaPuff", weight: 400, rotate: 1.5, anim: "blur" },
      { sizeMult: 0.95, font: "DynaPuff", weight: 400, ls: 0.12, anim: "rise" },
    ],
  },
  {
    id: "poster",
